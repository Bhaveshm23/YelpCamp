...
delete req.body.campground.rating; //we need to delete the previous rating
...
//DESTORY CAMPGROUND ROUTE and aslo destroy the comments and review associated with it to cleanup database
